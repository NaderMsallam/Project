...
export class ItemsComponent implements OnInit,OnDestroy {
  ...
  constructor(private itemsService: ItemsService, private api: ServerApiService, private router:Router, private tempItem:TempItemService) { }
  items:any;
  ngOnInit(): void {
  ...
  getAllItems(){
    this.subscription = this.api.getAllItems().subscribe((res:any)=>{
      this.items=res;
